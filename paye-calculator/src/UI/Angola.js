...
function AngolaUI({ country }) {
  ...
  const calculatePAYE = (e) => {
    ...
    if (taxableIncome <= 70000) {
      ...
      paye = (3000 + 6500 + 8000 + 18000 + (taxableIncome - 300000) * 0.19) / 12;
    } else if (taxableIncome <= 1000000) {
      paye = (3000 + 6500 + 8000 + 18000 + 38000 + (taxableIncome - 500000) * 0.2) / 12;
    } else if (taxableIncome <= 1500000) {
      paye = (3000 + 6500 + 8000 + 18000 + 38000 + 100000 + (taxableIncome - 1000000) * 0.21) / 12;
    } else if (taxableIncome <= 2000000) {
      paye = (3000 + 6500 + 8000 + 18000 + 38000 + 100000 + 105000 + (taxableIncome - 1500000) * 0.22) / 12;
    } else if (taxableIncome <= 2500000) {
      paye = (3000 + 6500 + 8000 + 18000 + 38000 + 100000 + 105000 + 110000 + (taxableIncome - 2000000) * 0.23) / 12;
    } else if (taxableIncome <= 5000000) {
      paye = (3000 + 6500 + 8000 + 18000 + 38000 + 100000 + 105000 + 110000 + 115000 + (taxableIncome - 2500000) * 0.24) / 12;
    } else if (taxableIncome <= 10000000) {
      paye = (3000 + 6500 + 8000 + 18000 + 38000 + 100000 + 105000 + 110000 + 115000 + 600000 + (taxableIncome - 5000000) * 0.245) / 12;
    } else {
      paye = (3000 + 6500 + 8000 + 18000 + 38000 + 100000 + 105000 + 110000 + 115000 + 600000 + 1225000 + (taxableIncome - 10000000) * 0.25) / 12;
    }
          ...
          <div class="card-container">
            ...
            <h4 class="results-title">Results</h4>
                ...
                <div class="gross-pay">
                    ...
                    <h4 id="paye-value">{formatNumber(socialSecurity.toFixed(2))}</h4>
                </div>
                <div class="gross-pay">

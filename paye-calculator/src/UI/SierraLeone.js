    ...
    const calculatePAYE = (e) => {
      ...
      const computePAYE = (taxableIncome) => {
        ...
        if (taxableIncome <= 600000) {
            ...
            paye = (taxableIncome - 600000) * 0.15;
        } else if (taxableIncome <= 1800000) {
            paye = 90000 + (taxableIncome - 1200000) * 0.20;
        } else if (taxableIncome <= 2400000) {
            paye = 210000 + (taxableIncome - 1800000) * 0.25;
        } else {
            paye = 330000 + (taxableIncome - 2400000) * 0.30;
        }
      ...
      let socialSecurity = grossPay * 0.05;

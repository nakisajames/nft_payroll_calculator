...
function SeychellesUI({ country }) {
    ...
    const calculatePAYE = (e) => {
      ...
      const computePAYE = (taxableIncome) => {
        ...
        if (taxableIncome <= 8555.5) {
            paye = 0;
          } else if (taxableIncome <= 10000) {
            paye = (taxableIncome - 8555.5) * 0.15;
          } else if (taxableIncome <= 83333) {
            paye = ((taxableIncome - 10000) * 0.20) + 216;
          } else {
            paye = ((taxableIncome - 83333) * 0.30) + 14883.28;
          }
